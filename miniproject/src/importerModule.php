 ...
 ?>
 <h1  class="m-5" style="color:green;text-align:center ;font-family: 'Noto Serif', serif;">Importer Module</h1>
 ...
 if(isset($_POST["Import"]))
 {
     ...
     if($_FILES["file"]["size"] > 0)
     {
         ...
         while (($emapData = fgetcsv($file, 10000, ";")) !== FALSE)
         {
             //print_r($emapData);
             //exit(); 
             $sql="INSERT into  Module (titre_module,code_module,idNiveau) values ('$emapData[0]','$emapData[1]','$emapData[2]','$emapData[3]')";
             $bd->exec($sql);
     ...
     echo '<p style="color:orange">l\'identifiant d\'un niveau  n\'existe pas ou plus </p>';
