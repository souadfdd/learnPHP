 ...
 ?>
 <h1  class="m-5" style="color:green;text-align:center ;font-family: 'Noto Serif', serif;">Importer Niveau</h1>
 ...
 if(isset($_POST["Import"]))
 {
     ...
     if($_FILES["file"]["size"] > 0)
     {
         ...
         while (($emapData = fgetcsv($file, 10000, ";")) !== FALSE)
         {
             //print_r($emapData);
             //exit(); 
             $sql="INSERT into Niveau (titre_niveau,alias,idFiliere)values ('$emapData[0]','$emapData[1]','$emapData[2]')";
             $bd->exec($sql);
     ...
     echo '<p>l\'identifiant d\'un Filière n\'existe pas  </p>';
